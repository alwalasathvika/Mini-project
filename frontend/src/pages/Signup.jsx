...
const Signup = () => {
  ...
  return <section className='px-5 cl:px-0'>
        ...
        <div className="rounded-l-lg lg:pl-16 py-10">
          ...
          <div className='mb-5'>
            <input 
              ...
              className='w-full py-3 pr-4 border-b border-solid border-[#0066ff61] focus:outline-none focus:border-b-primaryColor text-[22px] leading-7 text-headingColor placeholder:text-textColor cursor-pointer' 
              required 
            />
          </div>
          <div className='mb-5'>
          ...
          <div className=" mb-5 flex items-center justify-between">
            <label htmlFor="" className=" text-headingColor font-bold text-[13px] leading-7">
              Are you a:
          ...
          <div className="mb-5 flex items-center gap-3">
            <figure className="w-[60px] h-[60px] rounded-full border-2 border-solid border-primaryColor items-center flex justify-center">
          ...
          <div className='mt-7'>
            <button type='submit'
             className='w-full bg-primaryColor text-white text-[18px] leading-[30px] rounded-lg'>Sign Up</button>
          </div>
