...
const socialLinks = [
  {
    path: "https://github.com/alwalasathvika/Mini-project",
  ...
  {
    path: "https://www.linkedin.com/in/a-sathvika-reddy-372bbb227/",
        ...
        <div className='flex justify-between flex-col md:flex-row flex-wrap gap-[30px]'>
          <div>
            ...
            <p className='text-[16px] leading-7 font-[400] text-textColor mt-4'>
              Copyright © {year} developed by Sathvika all rights reserved.
            </p>
